...
import it.unicam.cs.bdslab.triplematcher.RNASecondaryStructureParser.BondsContinueContext;
import it.unicam.cs.bdslab.triplematcher.RNASecondaryStructureParser.BondsEndContext;
import it.unicam.cs.bdslab.triplematcher.RNASecondaryStructureParser.BpseqContext;
import it.unicam.cs.bdslab.triplematcher.RNASecondaryStructureParser.BpseqFormatContext;
import it.unicam.cs.bdslab.triplematcher.RNASecondaryStructureParser.BpseqLineBondContext;
import it.unicam.cs.bdslab.triplematcher.RNASecondaryStructureParser.BpseqLineUnpairedContext;
import it.unicam.cs.bdslab.triplematcher.RNASecondaryStructureParser.CtContext;
import it.unicam.cs.bdslab.triplematcher.RNASecondaryStructureParser.CtFormatContext;
import it.unicam.cs.bdslab.triplematcher.RNASecondaryStructureParser.CtLineBondContext;
import it.unicam.cs.bdslab.triplematcher.RNASecondaryStructureParser.CtLineUnpairedContext;
import it.unicam.cs.bdslab.triplematcher.RNASecondaryStructureParser.EdbnOrAasFormatContext;
import it.unicam.cs.bdslab.triplematcher.RNASecondaryStructureParser.EdbnsContinueContext;
import it.unicam.cs.bdslab.triplematcher.RNASecondaryStructureParser.EdbnsEndContext;
import it.unicam.cs.bdslab.triplematcher.RNASecondaryStructureParser.SequenceContinueContext;
import it.unicam.cs.bdslab.triplematcher.RNASecondaryStructureParser.SequenceEndContext;
...
public class RNASecondaryStructureConstructor
	...
	// assign the whole sequence description to the RNASecondaryStructure
	this.s.description = this.descriptionBuffer.toString();
	//System.out.println("Description " + this.s.description);
	// assign the whole sequence to the RNASecondaryStructure
	this.s.sequence = this.sequenceBuffer.toString();
	//System.out.println("Sequence " + this.s.sequence);
	// set the size of the structure to the length of the sequence
	this.s.size = this.s.sequence.length();
	//System.out.println("Length " + this.s.size);
	// everything has been added to the structure, finalise it
	this.s.finalise();
    }
